<template>
  <UCard v-if="selected_champion">
    <div class="flex gap-5">
      <img
        :src="
          // selected_champion.logoUrl ||
          'https://th.bing.com/th/id/OIP.aO0ndqAKnfLtEgeKux1zWQHaGr?rs=1&pid=ImgDetMain'
        "
...
const GotoHall = (hall_code: string) => {
  return navigateTo(`/championship/${props.id}/hall/${hall_code}`);
};
</script>
